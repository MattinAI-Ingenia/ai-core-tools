...
class AgentRepository:
    ...
    def get_form_data_for_agent(db: Session, app_id: int, agent_id: int) -> Dict[str, List]:
        ...
        middlewares_list = [{"middleware_id": m.middleware_id, "name": m.name, "description": m.description, "middleware_type": m.middleware_type.value if m.middleware_type else "monitoring"} for m in middlewares]

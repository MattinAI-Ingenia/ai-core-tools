...
def _langsmith_io_processor(io: dict) -> dict:
    """Truncate trace inputs/outputs before sending to LangSmith to stay within limits."""
    return _truncate_langsmith_value(io, max_bytes=10_000)

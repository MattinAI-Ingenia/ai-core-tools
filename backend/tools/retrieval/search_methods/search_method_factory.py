...
The 'dense' (vector similarity) and 'bm25' (lexical) search methods are
implemented. Additional search methods (sparse/SPLADE, ...) are reserved as
future support and can be moved into IMPLEMENTED_SEARCH_METHODS once their
...
class SearchMethodFactory:
    ...
    IMPLEMENTED_SEARCH_METHODS = ("dense", "bm25")
